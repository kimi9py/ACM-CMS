...
<body>
	...
	<div class="container">
		...
		<div class="span9 main-content row-fluid">
			<h3 class="muted">用户修改</h3>

			<form action="../manager/userModifyC.action" method="post"
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="userid" name="userid" required="true"
							class="span4 m-wrap" value="${user.user_id }"><font
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="name" name="name" required="true"
							class="span4 m-wrap"  value="${user.nick }"><font
							style="font-weight: bold; font-size: 16px;" color="red">*</font>
						<span for="name" class="help-inline"></span>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input name="school" type="text" required="true"
							class="span4 m-wrap"  value="${user.school }"> <font
							style="font-weight: bold; font-size: 16px;" color="red">*</font>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input name="email" type="text" required="true"
							class="span4 m-wrap"  value="${user.email }"> <font
							style="font-weight: bold; font-size: 16px;" color="red">*</font>
						<span for="tel" class="help-inline"></span>
					</div>
				</div>
