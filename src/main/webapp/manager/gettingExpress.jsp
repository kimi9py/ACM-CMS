	...
	<div class="container-fluid">
		<div class="row-fluid">
				...
				<div class="well sidebar-nav">
					<ul class="nav nav-list">
						<c:if test="${currentUser.name != '总裁办'}">
							...
							<li class="active"><a href="gettingExpress.action">待审核</a></li>
			...
			<div class="span9 main-content">
				...
				<h2 class="title-line">待审核的申请书</h2>
								...
								<td>
									<div class="btn-group">
										<button class="btn btn-small" id="${i.count }"
											onclick="javascript:add1ToStatus(${i.count },${xx.oid},'getExpress.action')">通过</button>
