				...
				<div class="well sidebar-nav">
					<ul class="nav nav-list">
						<c:if test="${currentUser.name != '总裁办'}">
							...
							<li><a href="flushingExpress.action">待发出</a></li>
						</c:if>
						<!-- 总裁办才有 终审 权利 -->
						<c:if test="${currentUser.name == '总裁办'}">
							<li class="nav-header">终审处理</li>
							<li class="active"><a href="arrivingExpress.action">文件获取</a></li>
								...
								<td>
									<div class="btn-group">
										<button class="btn btn-small" id="${i.count }"
											onclick="javascript:add1ToStatus(${i.count },${xx.oid},'arriveExpress.action')">提取文件</button>
