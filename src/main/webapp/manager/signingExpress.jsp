				...
				<div class="well sidebar-nav">
					<ul class="nav nav-list">
						...
						<c:if test="${currentUser.name == '总裁办'}">
							...
							<li class="active"><a href="signingExpress.action">文件发出</a></li>
						</c:if>
								...
								<td>
									<div class="btn-group">
										<button class="btn btn-small" id="${i.count }"
											onclick="javascript:add1ToStatus(${i.count },${xx.oid},'signExpress.action')">发出文件</button>
