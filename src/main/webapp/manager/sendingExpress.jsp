				...
				<div class="well sidebar-nav">
					<ul class="nav nav-list">
						...
						<c:if test="${currentUser.name == '总裁办'}">
							...
							<li class="active"><a href="sendingExpress.action">文件签署</a></li>
								...
								<td>
									<div class="btn-group">
										<button class="btn btn-small" id="${i.count }"
											onclick="javascript:add1ToStatus(${i.count },${xx.oid},'sendExpress.action')">确认签署</button>
