...
<body>
	...
	<div class="container">
		...
		<div class="span9 main-content row-fluid">
			<h3 class="muted">试题管理修改</h3>

			<form action="../manager/proModifyC.action" method="post"
				class="form-horizontal" id="quckOrderForm">

				<div class="control-group">
					<label class="control-label">比赛id</label> <input type="hidden" name="id"
						value="${ xx.id}">
					<div class="controls">
						<select id="contest_id" name="contest_id">

							<option>${xx.contest_id}</option>
							...
							<td>
								<div class="controls">
									<input name="problem1" type="text" required="true"
										class="span4 m-wrap" value=${xx.problem_id }> <span
										for="tel" class="help-inline"></span>
								</div>
							</td>
							<td>
								<div class="controls">
									<input name="title1" type="text" class="span9 m-wrap"
										number="true" value=${xx.title }> <span for="weight"
