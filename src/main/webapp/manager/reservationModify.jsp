...
<body>
	...
	<div class="container">
		...
		<div class="span9 main-content row-fluid">
			...
			<form action="../manager/reModifyC.action" method="post"
				class="form-horizontal" id="quckOrderForm">

				<div class="control-group">
					<label class="control-label">比赛id</label> <input type="hidden"
						value="${ xx.id}" name="id">
					<div class="controls">
					...
					<h1></h1>
					<div class="control-group">
						<label class="control-label">要修改的用户学号</label>
						<div class="controls">
							<input type="text" value="${ xx.user_id}">
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">选择用户</label>
						<div class="controls">
							<select id="multiSelect" size="20" name="user">
