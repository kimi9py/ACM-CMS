...
<body>
	...
	<div class="container">
		...
		<div class="span9 main-content row-fluid">
			<h3 class="muted">比赛信息修改</h3>

			<form action="../manager/contestModifyC.action" method="post"
				...
				<div class="control-group">
					...
					<input type="hidden" name="id" required="true"
							class="span4 m-wrap" value="${xx.contest_id }"/>
					<div class="controls">
						<input type="text" name="title" required="true"
							class="span4 m-wrap" value="${xx.title }"><font
				...
				<div class="control-group">
					...
					<div id="start_datetimepicker" class="controls">
						<input name="start_time" type="text" required="true"
							value="${xx.start_time }"></input> <span class="add-on">
				...
				<div class="control-group">
					...
					<div id="end_datetimepicker" class="controls">
						<input name="end_time" type="text" required="true"
							value="${xx.end_time }"></input> <span class="add-on"> <i
				...
				<%-- <div class="control-group">
					...
					<div class="controls">
						<input name="description" type="text" required="true"
							class="span4 m-wrap" value="${xx.description }"> <font
							style="font-weight: bold; font-size: 16px;" color="red">*</font>
						<span for="tel" class="help-inline"></span>
					</div>
				</div> --%>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input name="paper_path" type="text" class="span4 m-wrap"
							number="true" value="${xx.paper_path}"> <span
				...
				<div class="control-group">
					<div class="controls">
						<button type="submit" class="btn btn-primary">
							<i class="icon-ok icon-white"></i>确定修改
						</button>
					</div>
				</div>
		</div>
