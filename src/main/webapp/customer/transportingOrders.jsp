			...
			<div class="span2">
				<div class="well sidebar-nav">
					<ul class="nav nav-list">
						...
						<li class="active"><a href="transportingOrders.action">进行中申请</a></li>
								...
								<td>
									<div class="btn-group">
										<button class="btn btn-small"
											onclick="window.location.href='untransportingOrder.action?oid=${xx.oid}'">详情</button>
