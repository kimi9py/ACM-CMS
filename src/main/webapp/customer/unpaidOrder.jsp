	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="span9 main-content">
				<h2 class="title-line">未提交申请书订单详情</h2>
				...
				<form class="form-horizontal">
					...
					<div class="control-group">
						<label class="control-label">职位头衔名</label>
						<div class="controls">
							<input type="text" name="receiverName"
								value="${quickOrder.jobTitle}" disabled="disabled"
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="receiverNumber" type="text" required="true"
								class="span4 m-wrap" value="${quickOrder.jobComment}"
								disabled="disabled"> <font
								style="font-weight: bold; font-size: 16px;" color="red">*</font>
							<span for="tel" class="help-inline"></span>
						</div>
					...
					<div class="control-group">
						<label class="control-label">预计月薪</label>
						<div class="controls">
							<input name="weight" type="text" class="span4 m-wrap"
								value="${quickOrder.mouthSalary}" disabled="disabled"
								number="true"> (RMB)<span for="weight"
					...
					<div class="control-group">
						...
						<div class="controls">
							<textarea rows="2" id="remark" name="note" maxlength="20"
								class="span4" style="resize: none;" disabled="disabled">${quickOrder.note}</textarea>
					...
					<div class="class="row-fluid">
						<div class="span2"></div>
						<div class="span2">
							<a class="btn btn-large btn-primary" href="javascript:pay();">确定提交</a>
						</div>
						<div class="span6">
							<a class="btn btn-large btn-primary" href="javascript:cancel();">取消提交</a>
						</div>
